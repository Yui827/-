...
<ul>
	...
	<div class="p">
		<a href="/project/page.php">首页:</a>
		<a href="/project/doctor_classify/3.php">古代名医 -> 周汉晋</a>
	</div>
		<div class="main">
		<?php
			//连接数据库
			...
			if($page_search==null){
                ...
                //拼写sql语句
                $sql="select * from doctor_周汉晋 limit ".$startpage.",".$pagesize." ;";
                $str='select * from doctor_周汉晋 where 古代名医 like "%'.$search.'%"';
                //执行sql语句
		...
		$nextpage=$page+1;
		echo '<a href="/project/doctor_classify/3.php?page='.$prvpage.'">上一页</a>&nbsp;&nbsp;'.'第'.$page.'页'.'&nbsp;&nbsp;<a href="/project/doctor_classify/3.php?page='.$nextpage.'">下一页</a>'			
		?>
		</div></div>
</body>
</html>