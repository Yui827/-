...
<div class="no" >
    ...
    <div>
    <div style="text-align:center;">【祛风湿】</div>
    <br>
    <div style="padding:0px 500px;">
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;凡是以针对风湿病症状进行治疗的药物,叫做祛风湿。</div>
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本类药物以驱除寒湿、活血化瘀为主要原则,以缓解关节、肌肉等部位的疼痛和不适感以达到目的。</div>
    <br>
    </div></div>
    </div>
</div>
...
<div class="cle">
    ...
    //拼写sql语句
    $sql="select * from 祛风湿 limit ".$startpage.",".$pagesize.";";
    $str='select * from 祛风湿 where 药材名 like "%'.$search.'%";';
    //执行sql语句
...
$nextpage=$page+1;
echo '<div class="page"><a href="/project/medicine_classify/18.php?page='.$prvpage.'">上一页</a>&nbsp;&nbsp;'.'第'.$page.'页'.'&nbsp;&nbsp;<a href="/project/medicine_classify/18.php?page='.$nextpage.'">下一页</a></div>';
?>     
