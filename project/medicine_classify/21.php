...
<div class="cle">
    ...
    //拼写sql语句
    $sql="select * from 其他 limit ".$startpage.",".$pagesize.";";
    $str='select * from 其他 where 药材名 like "%'.$search.'%";';
    //执行sql语句
...
$nextpage=$page+1;
echo '<div class="page"><a href="/project/medicine_classify/21.php?page='.$prvpage.'">上一页</a>&nbsp;&nbsp;'.'第'.$page.'页'.'&nbsp;&nbsp;<a href="/project/medicine_classify/21.php?page='.$nextpage.'">下一页</a></div>';
?>     
