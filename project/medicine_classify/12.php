...
<div class="no" >
    ...
    <div>
    <div style="text-align:center;">【消食药】</div>
    <br>
    <div style="padding:0px 500px;">
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;凡以消积导滞、促进消化、治疗饮食积滞为主要作用的药物,称为消食药。</div>
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本类中药具有消化饮食积滞、开胃和中的功能。主要用于饮食积滞,腕腹胀满、恶心呕吐、不思饮食、大便失常等脾胃虚弱的消化不良证。</div>
    <br>
    </div></div>
    </div>
</div>
...
<div class="cle">
    ...
    //拼写sql语句
    $sql="select * from 消食药 limit ".$startpage.",".$pagesize.";";
    $str='select * from 消食药 where 药材名 like "%'.$search.'%";';
    //执行sql语句
...
$nextpage=$page+1;
echo '<div class="page"><a href="/project/medicine_classify/12.php?page='.$prvpage.'">上一页</a>&nbsp;&nbsp;'.'第'.$page.'页'.'&nbsp;&nbsp;<a href="/project/medicine_classify/12.php?page='.$nextpage.'">下一页</a></div>';
?>     
