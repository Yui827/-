...
<div class="no" >
    ...
    <div>
    <div style="text-align:center;">【涌吐药】</div>
    <br>
    <div style="padding:0px 500px;">
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;凡以促使呕吐为主要作用的药物,称为涌吐药。</div>
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本类中药多为酸苦,可促使体内所停留的毒物、痰涎、宿食等通过呕吐的方法予以排除。</div>
    <br>
    <div>本类药物作用强烈,大都具有毒性,用时慎用。涌吐药止可暂投,中病则止,不可连服、久服。</div>
    <br>
    </div></div>
    </div>
</div>
...
<div class="cle">
    ...
    //拼写sql语句
    $sql="select * from 涌吐药 limit ".$startpage.",".$pagesize.";";
    $str='select * from 涌吐药 where 药材名 like "%'.$search.'%";';
    //执行sql语句
...
$nextpage=$page+1;
echo '<div class="page"><a href="/project/medicine_classify/16.php?page='.$prvpage.'">上一页</a>&nbsp;&nbsp;'.'第'.$page.'页'.'&nbsp;&nbsp;<a href="/project/medicine_classify/16.php?page='.$nextpage.'">下一页</a></div>';
?>     
