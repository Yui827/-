...
<div class="no" >
    ...
    <div>
    <div style="text-align:center;">【温里药】</div>
    <br>
    <div style="padding:0px 500px;">
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;凡以温里祛寒、治疗里寒证为主要作用的药物，称为温里药。</div>
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本类中药都是温热性质，具有温里散寒、回阳救逆、温经止痛等作用。主要用于寒症及心肾阳虚所引起的亡阳证。</div>
    <br>
    <div>凡实热证、阴虚火旺、津血亏虚者异用；孕妇及气候炎热时慎用。</div>
    <br>
    </div></div>
    </div>
</div>
...
<div class="cle">
    ...
    //拼写sql语句
    $sql="select * from 温里药 limit ".$startpage.",".$pagesize.";";
    $str='select * from 温里药 where 药材名 like "%'.$search.'%";';
    //执行sql语句
...
$nextpage=$page+1;
echo '<div class="page"><a href="/project/medicine_classify/8.php?page='.$prvpage.'">上一页</a>&nbsp;&nbsp;'.'第'.$page.'页'.'&nbsp;&nbsp;<a href="/project/medicine_classify/8.php?page='.$nextpage.'">下一页</a></div>';
?>     
