...
<div class="no" >
    ...
    <div>
    <div style="text-align:center;">【理气药】</div>
    <br>
    <div style="padding:0px 500px;">
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;凡以输理气机、治疗气滞或气逆证为主要作用的药物,称为理气药。</div>
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本类中药具有调理气分、疏畅气机、消除气滞的功能。主要用于脾胃气滞引起的脘腹胀痛、不思饮食及肝郁气滞引起的胸胁胀痛、月经不调等病证。</div>
    <br>
    <div>本类中药性多辛温香燥,易耗气伤阴,气阴不足者慎用。</div>
    <br>
    </div></div>
    </div>
</div>
...
<div class="cle">
    ...
    //拼写sql语句
    $sql="select * from 理气药 limit ".$startpage.",".$pagesize.";";
    $str='select * from 理气药 where 药材名 like "%'.$search.'%";';
    //执行sql语句
...
$nextpage=$page+1;
echo '<div class="page"><a href="/project/medicine_classify/9.php?page='.$prvpage.'">上一页</a>&nbsp;&nbsp;'.'第'.$page.'页'.'&nbsp;&nbsp;<a href="/project/medicine_classify/9.php?page='.$nextpage.'">下一页</a></div>';
?>     
