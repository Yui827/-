...
<div class="no" >
    ...
    <div>
    <div style="text-align:center;">【化湿药】</div>
    <br>
    <div style="padding:0px 500px;">
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;凡气味芳香,性偏温燥,具有化湿运脾作用的药物,称为化湿药。</div>
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本类药物辛散轻扬,主入肺、膀胱经,偏行肌表,有促进肌体发汗,使表邪由汗出而解的作用,从而达到治愈表证,防止疾病传变的目的。</div>
    <br>
    <div>本类中药气味芳香,性质温燥,具有宣化湿浊、疏畅气机、健脾醒胃等作用。适用于湿浊内阻、脾为湿困、运化失常所致的病症。</div>
    <br>
    <div>阴虚血燥及气虚者慎用。</div>
    <br>
    </div></div>
...
<div class="cle">
    ...
    //拼写sql语句
    $sql="select * from 化湿药 limit ".$startpage.",".$pagesize.";";
    $str='select * from 化湿药 where 药材名 like "%'.$search.'%";';
    //执行sql语句
...
$nextpage=$page+1;
echo '<div class="page"><a href="/project/medicine_classify/4.php?page='.$prvpage.'">上一页</a>&nbsp;&nbsp;'.'第'.$page.'页'.'&nbsp;&nbsp;<a href="/project/medicine_classify/4.php?page='.$nextpage.'">下一页</a></div>';
?>     
