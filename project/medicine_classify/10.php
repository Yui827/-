...
<div class="no" >
    ...
    <div>
    <div style="text-align:center;">【驱虫药】</div>
    <br>
    <div style="padding:0px 500px;">
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;凡以驱除或杀灭人体寄生虫为主要作用的药物,称为驱虫药。</div>
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本类中药多具毒性,入脾、胃、大肠经,对人体内的寄生虫有毒杀、麻痹作用促使其排出体外。主要用于驱杀体内寄生虫,如蛔虫、蛲虫、姜片虫、绦虫、钩虫等。</div>
    <br>
    <div>驱虫药一般应在空腹时服用。孕妇、年老体弱者慎用。</div>
    <br>
    </div></div>
    </div>
</div>
...
<div class="cle">
    ...
    //拼写sql语句
    $sql="select * from 驱虫药 limit ".$startpage.",".$pagesize.";";
    $str='select * from 驱虫药 where 药材名 like "%'.$search.'%";';
    //执行sql语句
...
$nextpage=$page+1;
echo '<div class="page"><a href="/project/medicine_classify/10.php?page='.$prvpage.'">上一页</a>&nbsp;&nbsp;'.'第'.$page.'页'.'&nbsp;&nbsp;<a href="/project/medicine_classify/10.php?page='.$nextpage.'">下一页</a></div>';
?>     
