...
<div class="no" >
    ...
    <div>
    <div style="text-align:center;">【开窍药】</div>
    <br>
    <div style="padding:0px 500px;">
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;凡以辛香走窜之性,以开窍醒神为主要作用,用于治疗闭证神昏病证的药物,称开窍药。</div>
    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本类药物味辛、芳香,善于走窜,入心经,有通关开窍、启闭回苏的作用。主治惊风、癫痫、中风等病证。</div>
    <br>
    </div></div>
    </div>
</div>
...
<div class="cle">
    ...
    //拼写sql语句
    $sql="select * from 开窍药 limit ".$startpage.",".$pagesize.";";
    $str='select * from 开窍药 where 药材名 like "%'.$search.'%";';
    //执行sql语句
...
$nextpage=$page+1;
echo '<div class="page"><a href="/project/medicine_classify/17.php?page='.$prvpage.'">上一页</a>&nbsp;&nbsp;'.'第'.$page.'页'.'&nbsp;&nbsp;<a href="/project/medicine_classify/17.php?page='.$nextpage.'">下一页</a></div>';
?>     
