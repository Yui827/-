...
<ul>
	...
	<h1> 堪怜本草为经卷,无愧千金称药王</h1>
		...
		<form action="" method="post">
		<input type="text" name="page_search" value="请输入需要跳转页面" class="input_2">
	...
	<div class="background">
		<div class="p">
			<a href="/project/page.php">首页:</a>
			<a href="/project/book_classify/1.php">中医典籍 -> 全部</a>
		</div>
		<div class="main">
		<?php
			//连接数据库
			...
			if($page_search==null){
                ...
                //拼写sql语句
                $sql="select * from book limit ".$startpage.",".$pagesize." ;";
                $str='select * from book where 中医典籍 like "%'.$search.'%"';
                //执行sql语句
		...
		$nextpage=$page+1;
		echo '<a href="/project/book_classify/1.php?page='.$prvpage.'">上一页</a>&nbsp;&nbsp;'.'第'.$page.'页'.'&nbsp;&nbsp;<a href="/project/book_classify/1.php?page='.$nextpage.'">下一页</a>'			
		?>
		</div></div>
</body>
</html>